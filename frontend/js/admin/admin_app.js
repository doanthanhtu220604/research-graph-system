...
/* ============================================================
   ADMIN PROFILE AVATAR DROPDOWN & DIALOGS
   ============================================================ */
...
window.initAdminProfile = function() {
    ...
    if (headerActions) {
        const helloSpan = Array.from(headerActions.querySelectorAll('span')).find(span => span.textContent.includes('Xin chào'));
        if (helloSpan) {
            ...
            dropdownContainer.innerHTML = `
                ...
                <div class="profile-menu">
                    ...
                    <button onclick="logoutAdmin()" class="profile-menu-item logout-item">
                        <i class="fas fa-sign-out-alt"></i> Đăng xuất
                    </button>
                </div>
            `;
            helloSpan.replaceWith(dropdownContainer);
        }
    }
